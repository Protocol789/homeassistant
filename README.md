...
3. Time to test!  
  ...
  5. Place the following yaml into the file and ensure your update the `$username` and `$pasword`
     The scan interval is set to 30 minutes but can be set to any value you need (in seconds)
     Save the file  
     ```yaml
     command_line:
       - sensor:
     ...
     ```
      ![image](https://github.com/Protocol789/homeassistant/assets/44654683/5487f67a-5431-4d3a-b3f6-968e9c1d1761)
  6. Now restart Home Assstant
     This can be done directly from File Editor  
     ![image](https://github.com/Protocol789/homeassistant/assets/44654683/fe3f2334-c683-44fd-b34b-e0c3f56e3dee)
...
* `-G` Debug
  ...
  2024-01-12 00:35:12 - DEBUG --- Variable passed in postion 1: 966315711
  2024-01-12 00:35:12 - DEBUG --- Variable passed in postion 2: Airtel78!
  2024-01-12 00:35:12 - DEBUG --- Running payload creator
  2024-01-12 00:35:12 - DEBUG --- This is login payload:
  {"username":"966315711","password":"Airtel78!"}
